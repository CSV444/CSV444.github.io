...
<head>
    ...
    <style>
        ...
        *{ box-sizing:border-box; }
        ...
        .frame{ position:relative; width:min(920px, 100vw); aspect-ratio:3/4; padding:4.5rem 3rem; }
        .frame::before{
        ...
        .logo-img{ width:min(360px, 45%); height:auto; filter: drop-shadow(0 12px 24px rgba(0,0,0,.45)); }
        .logo-wrap::after{
        ...
        .site-header{
            ...
            display:flex;
            align-items:center;
            justify-content:center; /* correction : logo centré */
            pointer-events:auto;
        }
...
<main class="frame" role="main" aria-label="CSV Horlogerie — vitrine">
    ...
    <div class="stack">
        ...
        <section class="centerpiece" aria-label="logo principal">
            <div class="logo-wrap" id="logoWrap" style="display: flex; align-items: center; justify-content: center;">
                <img src="logo-csv.png" alt="Logo CSV Horlogerie" class="logo-img" style="margin-top: 1.5rem"/>
            </div>
        </section>
